...
for instance = 1:10
    ...
    for i = [1:j-1 j+1:12]
        ...
        for k = 1:12
            ...
            tmp_source = data_sources{instance,k};
            tmp_gm = gms{instance,k};
            for ii = 1:2
        ...
        %% training CSP using new covariance matrix. data_source is useless
        [ csp_coeff2,all_coeff2] = csp_analysis(new_source,9,csp_per_class, 0,new_gm);
        [ data_source_filter2 ] = csp_filtering(new_source, csp_coeff2);
        ...
        [X_LDA, estimate_performance] = lda_apply(Xproj2(size_xproj2+1:end,:), W2, B2);
