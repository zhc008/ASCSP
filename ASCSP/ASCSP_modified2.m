...
%     fprintf(fileID,'Tain ID %d\n',sub_idx);
    ...
    name = ['../Motor_Imagery_Data/',SUBS_NAM{sub_idx}, 'freqs7_12_shams_FP.mat'];
    load(name)
    ...
    for target_idx= [1:sub_idx-1 sub_idx+1:6]
        ...
        name = ['../data/',SUBS_NAM{target_idx}, 'freqs7_12_shams_FP.mat'];
        load(name)
...
%         gm{1} = squeeze(cm(sub_idx, 1, freqs_idx, 1, :,:));
        ...
        [gm1,store_idx] = update_v1_modified(gm,data_source,data_target);
