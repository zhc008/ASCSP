...
for instance = 1:10
    ...
    denominator = 0;
    predicted_ys2 = zeros(size(y_test_t,1),1);
...
for instance = 1:10
    ...
    predicted_ys2 = predicted_ys2 + predicted_y_classes{instance};
end
for ii = size(y_test_t,1)
    if predicted_ys2(ii) == 0
        predicted_ys2(ii) = sum(X_LDA(ii,:));
    end
end
    predicted_y_class1 = sign(predicted_ys2);
