...
%         end
        [gm1,store_idx] = new_update_test2(gm,X1_s,X2_s,X_test_t);
        ...
        size_xproj1 = size(f_X1_s,1);
        size_xproj2 = size(f_X2_s,1);
        size_xproj = size_xproj1 + size_xproj2;
        classified_y_test = simpleLDA(Xproj(1:size_xproj1,:), Xproj(size_xproj1+1:size_xproj,:), Xproj(size_xproj+1:end,:));
