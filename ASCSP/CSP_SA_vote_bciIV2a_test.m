% CSP_SA_vote_weighted using after the fact accuracy.m
...
%         end
    ...
    for i = [1:j-1 j+1:9]
        ...
        predicted_y_class2(predicted_y_class2 == 1) = 2;   % incorrect choice
        predicted_y_class2(predicted_y_class2 == -1) = 1;
        test_err2 = sum(abs(y_test_t - predicted_y_class2))/size(y_test_t, 1);
        weight = 1-test_err2;
%         if weight <= 0.5
