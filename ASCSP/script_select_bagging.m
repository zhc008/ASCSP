...
%     freqs = freqsCell{1} 
    ...
    train_NUM_a = floor(0.7 * NUM_a);
    train_NUM_t = floor(0.7 * NUM_t);
    
    aL_train = aL_train(1:train_NUM_a,:,:);
    tL_train = tL_train(1:train_NUM_t,:,:);
    aR_train = aR_train(1:train_NUM_a,:,:);
    tR_train = tR_train(1:train_NUM_t,:,:);
    
    % save the data 
    disp('saving data')
    save(['C:/Users/CZN/Documents/Balanced_mahta_data/bagging/S',num2str(i),'_I',num2str(instance),'_calib.mat'],...     
...
%     freqs = freqsCell{1} 
    ...
    % save the data 
    disp('saving data')
    save(['C:/Users/CZN/Documents/Balanced_mahta_data/bagging/S',num2str(i),'_I',num2str(instance),'_onln.mat'],...     
